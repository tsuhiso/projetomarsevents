...
if (isset($_POST['salvar']) && (isset($_FILES['img_perfilnovo']))) {
    ...
    $cadastro_eve = mysqli_query($conn, "UPDATE fornecedor set foto = '$nome_img' WHERE id = '$dados[id]'");

    $result3 = mysqli_query($conn, "SELECT * FROM fornecedor WHERE email = '$dados[email]'");
