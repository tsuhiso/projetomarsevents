...
<body>  
<form action="veri_user.php" method="POST">
<div class="limiter">
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Digite seu email">
						<input class="input100" type="email" name="email_log" required>
					...
					<div class="wrap-input100 validate-input" data-validate="Digite sua senha">
						...
						<input class="input100" type="password" name="senha_log" required>
					...
					<div class="text-center p-t-15">
						...
						<a class="txt2" href="../cadastro/cadastrar_usu.php">
							Se cadastre.
						</a>
					</div>
				</form>
