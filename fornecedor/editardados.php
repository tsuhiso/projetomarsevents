...
if(isset($_POST['submit'])){
    ...
    window.location.href= '../fornecedor/perfil_fornecedor.php'; </script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Poppins:wght@700&display=swap" rel="stylesheet">
    <link href="css/editardadosforn.css" rel="stylesheet">
...
<header>
    <nav>
        <ul class="nav-list">
                <li><a href="../fornecedor/perfil_fornecedor.php"><button>Voltar</button></a></li>
        </ul>
    </nav>
</header>
