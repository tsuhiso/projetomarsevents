                            ...
                            <div class="col-lg-6 col-md-2 col-12 pe-lg-0">
                                <div class="contact-info contact-info-border-start d-flex flex-column">
                                    ...
                                    <ul class="social-icon">
                                        ...
                                        <li class="social-icon-item"><a href="#" class="social-icon-link2 bi-instagram"></a></li>

                                        <li class="social-icon-item"><a href="#" class="social-icon-link2 bi bi-envelope"></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
