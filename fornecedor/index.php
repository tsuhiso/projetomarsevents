    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_2">Como fornecer serviço</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_3">Eventos disponíveis</a>
                        </li>

                    </ul>

                    <div class="d-lg-flex align-items-center d-none ms-auto">
                        <li class="social-icon-item"><a href="perfil_fornecedor.php" class="social-icon-link bi-person-fill"></a></li>
                    </div>
        ...
        <main>
            ...
            <section class="about section-padding" id="section_2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-12 mt-4 mb-lg-0">
                            <img src="images/Astronaut suit-pana.png" class="about-image img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12  d-flex flex-column">
                            <div class="about-thumb">
                                            ...
                                            <div class="col-8">
                                            <h4>Como fornecer serviço</h4>
                                                <hr color="purple" width="30%" size="5px"/>

                                                <h6>Fornecer serviço de forma segura e prática</h6>
                                                <br>
                                            </div>
                                            <div class="row">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <div class="widget-49">
                                                            ...
                                                            <ol class="widget-49-meeting-points">
                                                                <li class="widget-49-meeting-item"><span>Selecione o evento disponível que deseja prestar serviço</span></li>
                                                ...
                                                <div class="card card-margin">
                                                    ...
                                                    <div class="card-body pt-0">
                                                        <div class="widget-49">
                                                            ...
                                                            <br>
                                                            <ol class="widget-49-meeting-points">
                                                                <li class="widget-49-meeting-item"><span>Entre em contato com o responsável do evento e confirme seu serviço</span></li>
                        ...
                        <div class="col-lg-12 col-12">
                            <div class="profile-thumb">
                                <div class="profile-title">
                                    <h4 class="mb-0">Eventos recentemente publicados que você pode oferecer serviço  </h4>
                            ...
                            <div class="col-lg-6 col-md-2 col-12 pe-lg-0">
                                <div class="contact-info contact-info-border-start d-flex flex-column">
                                    ...
                                    <ul class="social-icon">
                                        <li class="social-icon-item"><a href="https://twitter.com/minthu" class="social-icon-link2 bi-twitter"></a></li>

                                        <li class="social-icon-item"><a href="https://instagram.com/marseventsenai" target="_blank" class="social-icon-link2 bi-instagram"></a></li>

                                        <li class="social-icon-item"><a href="mailto:marseventssenai@gmail.com" class="social-icon-link2 bi bi-envelope"></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
